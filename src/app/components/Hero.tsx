...
const Hero = () => {
    return (
        <section className="container mx-auto w-full px-4 py-8 md:px-6 md:py-12">
            <div
                className="flex min-h-[478px] flex-col-reverse   items-center justify-between  gap-8 overflow-hidden rounded-2xl border  border-[#292C34]   bg-[#15171D]  px-6   py-8  md:px-10   lg:flex-row  lg:gap-0  lg:px-16  lg:py-10  "
            >
